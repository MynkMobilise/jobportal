...
<!-- Mirrored from demo-egenslab.b-cdn.net/html/jobes/preview/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Feb 2024 06:09:56 GMT -->
<head>
<meta charset="UTF-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>JOBES- Job Portal </title>
...
<div class="top-bar2">
<p>Welcome Our Job Portal! <a href="bookmark.html">Find Jobs</a></p>
...
<a href="index"><img alt="image" class="img-fluid" src="assets/images/header1-logo.svg"></a>
</div>
<div class="main-menu">
<div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
<div class="mobile-logo-wrap">
<a href="index"><img alt="image" src="assets/images/header1-logo.svg"></a>
</div>
...
<li class="">
<a href="aboutus" class="drop-down">About us</a><i class="bi bi-plus dropdown-icon"></i>
<li class="">
<a href="jobcategory" class="drop-down">Job Category</a><i class="bi bi-plus dropdown-icon"></i>
<li class="">
<a href="job-listing" class="drop-down">Job List</a><i class="bi bi-plus dropdown-icon"></i>

</li>
<li class="">
<a href="priceplan" class="drop-down">Pricing Plan</a><i class="bi bi-plus dropdown-icon"></i>
